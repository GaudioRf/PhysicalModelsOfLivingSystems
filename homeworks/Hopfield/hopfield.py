...
ani = animation.FuncAnimation(fig, animation_update, init_func=animation_init, frames=TOTAL_FRAMES, interval=DT_FRAMES, blit=False, repeat=False) # blit is used to make simulation faster
#plt.show()
